...
import { Info, ShieldAlert, Database, DollarSign, Scale, GitMerge, Lock, FileText, CheckCircle2 } from 'lucide-react';
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div className="detail-section" style={{ background: 'linear-gradient(135deg, rgba(30, 41, 59, 0.6) 0%, rgba(15, 23, 42, 0.9) 100%)', borderLeft: '4px solid var(--accent-blue)', padding: '2rem', borderRadius: '12px' }}>
        ...
        <p style={{ fontSize: '1.025rem', color: '#e2e8f0', lineHeight: 1.7, maxWidth: '75ch' }}>
          The <strong>Global AI Incident Monitor (AIIM)</strong> is an enterprise-grade safety analytics platform providing real-time multi-source intelligence on artificial intelligence harms, rogue autonomous agent activity, security breaches, regulatory enforcement, and economic losses.
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 340px', gap: '1.5rem', alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <section className="detail-section">
            ...
            <div style={{ fontSize: '0.95rem', color: 'var(--text-muted)', lineHeight: 1.75, display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              <p>
                In alignment with the <strong>OECD AI Principles</strong>, <strong>EU AI Act (Article 73)</strong>, the <strong>MIT AI Risk Repository</strong>, and the <strong>AI Incident Database (AIID)</strong>, an <em>AI Incident</em> is formally defined as:
              </p>
              <blockquote style={{ background: 'rgba(0,0,0,0.3)', borderLeft: '3px solid var(--accent-cyan)', padding: '0.85rem 1.25rem', borderRadius: '4px', color: 'var(--text-main)', fontStyle: 'italic' }}>
                "An event where the development, deployment, or operation of an artificial intelligence system directly causes, or significantly contributes to, real-world physical harm, property damage, mental harm, financial losses, fundamental rights violations, critical infrastructure compromise, or unsanctioned rogue autonomous agent behavior."
              </blockquote>
            </div>
          </section>
          ...
          <section className="detail-section">
            ...
            <div style={{ fontSize: '0.95rem', color: 'var(--text-muted)', lineHeight: 1.75, display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              <p>The platform aggregates raw news intelligence from four complementary channels:</p>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginTop: '0.5rem' }}>
                <div style={{ background: 'rgba(0,0,0,0.2)', padding: '1rem', borderRadius: '8px', border: '1px solid var(--border-color)' }}>
                  <h4 style={{ color: 'var(--accent-cyan)', fontSize: '0.85rem', marginBottom: '0.3rem' }}>Google News RSS</h4>
                ...
                <div style={{ background: 'rgba(0,0,0,0.2)', padding: '1rem', borderRadius: '8px', border: '1px solid var(--border-color)' }}>
                  <h4 style={{ color: 'var(--accent-purple)', fontSize: '0.85rem', marginBottom: '0.3rem' }}>GDELT 2.0 (BigQuery)</h4>
                ...
                <div style={{ background: 'rgba(0,0,0,0.2)', padding: '1rem', borderRadius: '8px', border: '1px solid var(--border-color)' }}>
                  <h4 style={{ color: '#34d399', fontSize: '0.85rem', marginBottom: '0.3rem' }}>ArXiv AI Safety</h4>
                  <p style={{ fontSize: '0.825rem' }}>Frontier research papers evaluating sandbox escapes, model alignment failures, and vulnerability disclosures.</p>
                </div>
                <div style={{ background: 'rgba(0,0,0,0.2)', padding: '1rem', borderRadius: '8px', border: '1px solid var(--border-color)' }}>
                  <h4 style={{ color: '#fdba74', fontSize: '0.85rem', marginBottom: '0.3rem' }}>AI Incident Database (AIID)</h4>
          ...
          <section className="detail-section">
            ...
            <div style={{ fontSize: '0.95rem', color: 'var(--text-muted)', lineHeight: 1.75, display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              <p>
                To quantify economic risk, Gemini 3.6 Flash evaluates the scraped full text of each incident according to three rigorous financial assessment tiers:
              </p>
          ...
          {/* Section 4: Regulatory Taxonomy & Deduplication Engine */}
          <section className="detail-section">
            <h3 style={{ fontSize: '1.1rem', fontWeight: 600, color: 'var(--text-main)', display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.75rem' }}>
            ...
            <div style={{ fontSize: '0.95rem', color: 'var(--text-muted)', lineHeight: 1.75, display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              <p>
                To prevent duplicate news reports (e.g. daily newspapers vs. weekly follow-ups) from inflating incident counts, the platform employs a dual-stage <strong>Fuzzy SequenceMatcher & Word-Jaccard Deduplicator</strong>:
              </p>
        ...
        {/* RIGHT SIDEBAR: QUICK FACTS & SYSTEM SPECIFICATIONS */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', position: 'sticky', top: '5rem' }}>
          ...
          <div className="detail-section">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', fontSize: '0.85rem', color: 'var(--text-main)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <CheckCircle2 size={14} style={{ color: '#34d399' }} /> EU AI Act (Art. 73) Tiers
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <CheckCircle2 size={14} style={{ color: '#34d399' }} /> CSET Harm Domains
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <CheckCircle2 size={14} style={{ color: '#34d399' }} /> MIT AI Risk Repository
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <CheckCircle2 size={14} style={{ color: '#34d399' }} /> OECD AI Taxonomy
              </div>
            </div>
          </div>
          ...
          <div className="detail-section">
            ...
            <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
              <span>• <strong>OIDC Keyless Auth</strong>: GCP Workload Identity Federation.</span>
              <span>• <strong>Row Level Security</strong>: Supabase PostgreSQL RLS enabled.</span>
              <span>• <strong>Data Minimization</strong>: Raw article full-texts protected in database.</span>
            </div>
          </div>
          ...
          <div className="detail-section" style={{ background: 'rgba(239, 68, 68, 0.08)', borderColor: 'rgba(239, 68, 68, 0.25)' }}>
            ...
            <p style={{ fontSize: '0.775rem', color: 'var(--text-muted)', lineHeight: 1.5 }}>
              Financial damage figures and taxonomy classifications are generated via automated LLM analysis of open-source intelligence. Values represent estimated economic indicators for safety research and risk assessment purposes.
            </p>
          </div>
